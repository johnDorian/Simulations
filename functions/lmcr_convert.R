...
################################################################################
### WARNINGS: LIMITED TESTING - RESULTS LOOK GOOD - For an istorpic exp model.
...
if(modtyp!=1)if(modtyp!=2)if(modtyp!=3)if(modtyp!=4)if(modtyp!=5)if(modtyp!=6)if(modtyp!=7)if(modtyp!=8)if(modtyp!=9)if(modtyp!=10)stop("your modtyp value is incorrect it must be between 1 and 8")
